...
def obtener_nivel_riesgo(ruta,accidentes_dep_rpi,perim_acotado,db):  # sustituir ruta cuando pasar al servidor  /home/ubuntu/SafeDrive2.0/simulacion_datos/uruguay.geojson

...
recorridos = pd.read_csv(r'C:\Users\agus9\Desktop\PFC\tablasSD\recorridos_simulados.csv') #COLOCAR LA RUTA DEL CSV DE LOS RECORRIDOS
eventos = pd.read_csv(r'C:\Users\agus9\Desktop\PFC\tablasSD\eventos_simulados.csv') #COLOCAR LA RUTA DEL CSV DE LOS EVENTOS
    
departamentos = gpd.read_file(r'C:\Users\agus9\Desktop\PFC\tablasSD\uruguay.geojson') #FUENTE: https://github.com/alotropico/uruguay.geo
...
recorridos_completos = recorridos_completos.drop(columns=['fecha_fin', 'distracciones', 'dormido', 'matricula_id', 'id_evento', 'velocidad', 'latitud', 'longitud', 'departamento'])
...
recorridos_completos.to_csv(r'C:\Users\agus9\Desktop\PFC\tablasSD\SafeDrive_simulado.csv') #EXPORTAR CSV / AJUSTAR LA RUTA DE SALIDA
